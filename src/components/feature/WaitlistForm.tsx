...
export default function WaitlistForm() {
    ...
    if (isSubmitted) return <WaitlistSuccess />;
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full max-w-md mx-auto space-y-3 px-2 py-4 md:mx-0">
            ...
            {error && <WaitlistError message={error} />}

            <button
                type="submit"
                disabled={isSubmitting}
                className="w-full font-medium border-primary-light shadow-primary/20 shadow-lg bg-primary-dark hover:bg-primary-dark/80 text-white py-1.5 rounded-lg transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
