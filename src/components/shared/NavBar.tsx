...
const NavBar = () => {
    ...
    return (
        <nav className=" w-full z-50 animate-fade-in-up">
            <div className="flex py-3.5 px-[clamp(20px,calc(20px+60*((100vw-375px)/1185)),80px)]
                  items-center justify-between shadow-sm border border-primary-light
                  shadow-primary/10 rounded-full bg-white max-w-[1440px] mt-3 mx-3">
